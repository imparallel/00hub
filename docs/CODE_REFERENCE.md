...
- **`TopMost = true`**: 생성자부터 고정되어 사용자가 명시적으로 최소화하지 않는 한 항상 화면 맨 위에 유지됩니다.
- **`DisplaySettingsChanged`**: 모니터 연결 변경 시 트레이 메뉴를 즉시 갱신합니다.
...
이 문서는 00Hub v1.6.0 기준으로 작성 및 갱신되었습니다 — 2026.03.22
